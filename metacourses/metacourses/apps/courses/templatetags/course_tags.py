...
@register.inclusion_tag("courses/course.html",takes_context=True)
def course(context,course):
    return {"course":course,"request":context['request']}


# got this snippet from http://djangosnippets.org/snippets/660/
